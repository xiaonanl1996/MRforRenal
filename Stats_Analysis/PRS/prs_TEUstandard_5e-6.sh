...
SBP_PRS=sbp_prs_NoBMISmok6_20211129
DBP_PRS=dbp_prs_NoBMISmok6_20211129
...
cat ./outputs/AfterQC.prune.out ./outputs/BmiObsSmok_5e-6.txt > ./outputs/ld_bmi_obs_smok.txt
